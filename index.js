...
const updateCredit = () => {
    ...
    rCreditHtml = `<div class = "text-center"> <h6 style = "color:#748eed;font-weight:600;" class = ""><p>Credits</p>: ${remainingCredit} <i class="fa fa-arrow-down" aria-hidden="true"></i></h6></div>`;
    uCreditHtml = `<div class = "text-center "><h6 style = "color:#07f20b; font-weight:600;" ><p>Credits</p>: ${usedCredit} <i class="fa fa-arrow-up" aria-hidden="true"></i></h6></div>`;
